 ...
 * The plate behind the text is a soft dark pill rather than a hard box — over a
 * neon-lit night street a hard box reads as a broadcast lower-third and kills
 * the hand-made feel the rest of the frame is working for.
 */

const FONT_SIZE = 52;
const LINE_HEIGHT = 1.3;
const BOTTOM_INSET = 0.17;
...
export const Captions: React.FC = () => {
  ...
  // A few pixels of rise on entry stops consecutive cues from looking like a
  // single block of text that only swaps characters.
  const rise = interpolate(frame, [fromFrame, fromFrame + FADE_FRAMES], [10, 0], {
